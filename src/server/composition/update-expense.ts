...
import type { UpdateExpenseDependencies } from "../use-cases/update-expense";
...
): UpdateExpenseDependencies["repositories"] {
  return {
...
export function createUpdateExpenseDependencies(): UpdateExpenseDependencies {
